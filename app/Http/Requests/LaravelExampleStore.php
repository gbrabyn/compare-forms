...
class LaravelExampleStore extends FormRequest
{
    /**
            ...
            'g-recaptcha-response' => [
                function($attribute, $value, $fail){    // reCAPTCHA validation
                    ...
                    if($validator->isValid() === false){
                        $fail(trans('dynamicForms.inputReCaptchaFail'));
                    }
                },
            ],
        ];
    ...
    {
        return [
            'countryId.required' => trans('dynamicForms.inputRequired'),
            'languages.required' => trans('messages.languagesRequired'),
            'additionalLanguages.*.distinct' => trans('dynamicForms.inputDuplicated'),
            'experience.*.companyName.required' => trans('dynamicForms.inputRequired'),
            'experience.*.officeCountryId.required' => trans('dynamicForms.inputRequired'),
            'experience.*.startDate.required' => trans('dynamicForms.inputRequired'),
            'experience.*.finishDate.required' => trans('dynamicForms.inputRequired'),
            'experience.*.finishDate.after_or_equal' => trans('messages.formAfterStartDate'),
            'experience.*.type.required' => trans('dynamicForms.inputRequired'),
            'experience.*.additionalLanguagesUsed.*.distinct' => trans('dynamicForms.inputDuplicated'),
        ];
    }
}
