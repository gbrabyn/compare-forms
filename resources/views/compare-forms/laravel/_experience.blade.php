    ...
    <div class="row">
        ...
        <div class="input-col">
            ...
            <table
                ...
                data-template="{!! attributeTemplate('compare-forms.laravel._list-row', ['name'=>'experience.'.$k.'.additionalLanguagesUsed.__index2__', 'nameAttribute'=>'experience['.$k.'][additionalLanguagesUsed][]', 'placeholder'=>trans('messages.Programming Language')]) !!}"
            >
                <tbody>
                @foreach (formIterator(($personExperience ?? null), 'experience.'.$k.'.additionalLanguagesUsed') as $key2)
                    @include('compare-forms.laravel._list-row', ['name'=>'experience['.$k.'][additionalLanguagesUsed]['.$key2.']', 'nameAttribute'=>'experience['.$k.'][additionalLanguagesUsed][]', 'placeholder'=>trans('messages.Programming Language')])
                @endforeach
                </tbody>
                <tfoot>
                <tr>
